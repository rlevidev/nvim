  ...
  },
  {
    ...
    dependencies = {
      "rafamadriz/friendly-snippets",
      {
        ...
        config = function()
          -- You can configure codeium/windsurf here.
          -- See :help codeium for all options.
          ...
          draw = {
            components = {
              kind_icon = {
                ellipsis = false,
                text = function(ctx)
                  local symbol_map = require("kide.lspkind").symbol_map
                  local symbol = symbol_map[ctx.kind] or symbol_map.Text
                  return symbol.icon or ""
                end,
                highlight = function(ctx)
                  local symbol_map = require("kide.lspkind").symbol_map
                  local symbol = symbol_map[ctx.kind] or symbol_map.Text
                  return symbol.hl or "@text"
                end,
              },
            },
          },
